    ...
    contributions: [
      {
        ...
        date: '2024-07-23T18:02:00Z',
        notification: 'Identified a bug in the settings update logic.',
        type: 'user',
      },
      {
        id: '11',
        user: 'alicejohnson',
        profile: 'images/profile11.png',
        date: '2024-07-23T18:09:00Z',
        notification: 'Confirmed the issue on the latest app version.',
        type: 'user',
      },
      {
        id: '12',
        ...
        date: '2024-07-23T18:20:00Z',
        notification: 'Fixed the settings update bug and tested the solution.',
        type: 'user',
      },
    ],
    user: 'janesmith',
    ...
    contributions: [
      {
        ...
        date: '2024-07-24T10:01:00Z',
        notification: 'Examined the logout process and found a race condition.',
        type: 'user',
      },
      {
        id: '14',
        ...
        date: '2024-07-24T10:06:00Z',
        notification: 'Reproduced the crash on various devices.',
        type: 'user',
      },
      {
        id: '15',
        user: 'janesmith',
        profile: 'images/profile15.png',
        date: '2024-07-24T10:11:00Z',
        notification: 'Implemented a fix to resolve the race condition.',
        type: 'user',
      },
    ],
    user: 'alicejohnson',
    ...
    contributions: [
      {
        id: '16',
        user: 'alicejohnson',
        profile: 'images/profile16.png',
        date: '2024-07-25T12:02:00Z',
        notification: 'Detected memory leaks causing the crashes.',
        type: 'user',
      },
      {
        id: '17',
        user: 'johndoe',
        profile: 'images/profile17.png',
        date: '2024-07-25T12:08:00Z',
        notification: 'Tested the app on older devices and confirmed the crashes.',
        type: 'user',
      },
      {
        id: '18',
        user: 'bobwilliams',
        profile: 'images/profile18.png',
        date: '2024-07-25T12:15:00Z',
        notification: 'Patched the memory leaks and improved performance.',
        type: 'user',
      },
    ],
    user: 'johndoe',
...
export const DUMMY_USERS = [
  {
    ...
    username: 'johndoe',
    email: [
      { address: 'johndoe@example.com', visibility: 'public', type: 'default' },
      { address: 'johndoe_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'johndoe_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'johndoe_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '123-456-7890',
    followersCount: 150,
    followingCount: 200,
  ...
  },
  {
    ...
    username: 'janesmith',
    email: [
      { address: 'janesmith@example.com', visibility: 'public', type: 'default' },
      { address: 'janesmith_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'janesmith_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'janesmith_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '987-654-3210',
    followersCount: 300,
    followingCount: 100,
  ...
  },
  {
    ...
    email: [
      { address: 'alicejohnson@example.com', visibility: 'public', type: 'default' },
      { address: 'alicejohnson_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'alicejohnson_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'alicejohnson_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '555-555-5555',
    followersCount: 500,
    followingCount: 400,
  ...
  },
  {
    ...
    email: [
      { address: 'bobwilliams@example.com', visibility: 'public', type: 'default' },
      { address: 'bobwilliams_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'bobwilliams_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'bobwilliams_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '444-333-2222',
    followersCount: 250,
    followingCount: 150,
  ...
  },
  {
    ...
    email: [
      { address: 'charliebrown@example.com', visibility: 'public', type: 'default' },
      { address: 'charliebrown_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'charliebrown_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'charliebrown_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '777-888-9999',
    followersCount: 180,
    followingCount: 220,
  ...
  },
  {
    ...
    email: [
      { address: 'dianaprince@example.com', visibility: 'public', type: 'default' },
      { address: 'dianaprince_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'dianaprince_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'dianaprince_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '222-111-0000',
    followersCount: 320,
    followingCount: 280,
  ...
  },
  {
    ...
    username: 'evanmiller',
    email: [
      { address: 'evanmiller@example.com', visibility: 'public', type: 'default' },
      { address: 'evanmiller_private@example.com', visibility: 'private', type: 'backup' },
      { address: 'evanmiller_work@example.com', visibility: 'private', type: 'backup' },
      { address: 'evanmiller_alt@example.com', visibility: 'public', type: 'backup' },
    ],
    phone: '333-444-5555',
    followersCount: 410,
    followingCount: 360,
